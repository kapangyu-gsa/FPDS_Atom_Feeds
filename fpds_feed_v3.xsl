...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        ...
        <!-- <xsl:apply-templates select="$content-nodeset" mode="generic">
        ...
        <xsl:apply-templates select="$content-nodeset" mode="generic">
            <xsl:with-param name="fieldname">contractingOfficeAgency-name</xsl:with-param></xsl:apply-templates>
        <xsl:apply-templates select="$content-nodeset" mode="generic">
            <xsl:with-param name="fieldname">contractingOfficeAgency-departmentID</xsl:with-param></xsl:apply-templates>
        <xsl:apply-templates select="$content-nodeset" mode="generic">
            <xsl:with-param name="fieldname">contractingOfficeAgency-departmentName</xsl:with-param></xsl:apply-templates>
        <xsl:apply-templates select="$content-nodeset" mode="generic">
        ...
        <xsl:apply-templates select="$content-nodeset" mode="generic">
            <xsl:with-param name="fieldname">GFE-GFP-description</xsl:with-param></xsl:apply-templates>
        <xsl:apply-templates select="$content-nodeset" mode="generic">
